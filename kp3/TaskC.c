...
long long Factorial(int Fn); //РАссчет факториала
long double sumT(int Sn, long double Sx); //Рассчет по формуле Тейлора
...
int main() {
	...
	int n, k; //Кол-во частей отрезка, коэффицент точности
